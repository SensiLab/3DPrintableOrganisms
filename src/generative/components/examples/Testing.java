...
//		String folderName = "../out/evo_output/prints/";
		String folderName = "../out/evo_output/meshes/";
		
		
		// last object in the process
//		double[] genes = {0.7971354411267045,0.679551696552745,0.43895084203454265,0.7669021860943841,0.5715081078078987};
		
		// first object in the process
		double[] genes = {0.7990660932945377,0.6798064718733912,0.47677836598081635,0.7648429580999971,0.6850857786733965};
		
		Chromosome chr = new Chromosome(genes);
		// Environment size set in millimiters
...
////		String fileName = "013_print-best-Coverage001_Run-000_ind-96";
		String fileName = "IEEE_Refine_014_R025_I001_v06";
//		String fileName = "IEEE_Refine_014_R025_I001_v01";
//		s.printColony(true, folderName+fileName);
